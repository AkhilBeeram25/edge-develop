"""Top-level YOLO Update model assembly."""
...
try:
    ...
    raise ImportError(
        "YOLOUpdateModel requires PyTorch. Install with "
        '`python3 -m pip install -e ".[torch]"`.'
    ) from exc

from .backbone import YOLOUpdateBackbone
from .heads import MaskPrototypeHead, UnifiedAnchorFreeHead
from .neck import YOLOUpdateNeck


@dataclass(frozen=True)
class YOLOUpdateConfig:
    """Model configuration for the YOLO Update family."""
